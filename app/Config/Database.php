...
class Database extends Config
{
    ...
    public function __construct()
    {
        ...
        // Allow overriding the DB config via the project's `env` file.
        // We set these in the constructor because property defaults
        // cannot contain function calls (would cause a PHP error).
